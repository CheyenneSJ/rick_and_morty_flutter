...
abstract class $LocationResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({Info info, List<String> results});
...
class _$_LocationResponse extends _LocationResponse {
  const _$_LocationResponse(
      {this.info = const Info(), final List<String> results = const []})
      : _results = results,
        super._();
  ...
  @override
  String toString() {
    return 'LocationResponse(info: $info, results: $results)';
  }
...
abstract class _LocationResponse extends LocationResponse {
  const factory _LocationResponse(
      {final Info info, final List<String> results}) = _$_LocationResponse;
